# CATARACT-CLASSIFICATION-DATASET Raw Data Directory

This directory should contain the raw cataract-classification-dataset dataset files downloaded from Kaggle.
...
- Maintain original file znames and directory structure for proper integration

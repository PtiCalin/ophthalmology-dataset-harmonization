# FUNDUS-IMAGE-REGISTRATION-DATASET Raw Data Directory

This directory should contain the raw fundus-image-registration-dataset dataset files downloaded from Kaggle.

# RETINAL-COLORIZED-OCT-DATASET Raw Data Directory

This directory should contain the raw retinal-colorized-oct-dataset dataset files downloaded from Kaggle.

# RETINAL-DISEASE-CLASSIFICATION-DATASET Raw Data Directory

This directory should contain the raw retinal-disease-classification-dataset dataset files downloaded from Kaggle.

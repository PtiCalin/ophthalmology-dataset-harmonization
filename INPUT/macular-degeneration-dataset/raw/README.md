# MACULAR-DEGENERATION-DATASET Raw Data Directory

This directory should contain the raw macular-degeneration-dataset dataset files downloaded from Kaggle.

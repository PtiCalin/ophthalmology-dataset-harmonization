# RETINAL-LAYER-SEGMENTATION-DATASET Raw Data Directory

This directory should contain the raw retinal-layer-segmentation-dataset dataset files downloaded from Kaggle.

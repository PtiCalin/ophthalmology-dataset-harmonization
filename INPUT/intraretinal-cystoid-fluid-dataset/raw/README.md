# INTRARETINAL-CYSTOID-FLUID-DATASET Raw Data Directory

This directory should contain the raw intraretinal-cystoid-fluid-dataset dataset files downloaded from Kaggle.

# DIABETIC-RETINOPATHY-CLASSIFICATION-DATASET Raw Data Directory

This directory should contain the raw diabetic-retinopathy-classification-dataset dataset files downloaded from Kaggle.

# DIABETIC-RETINOPATHY-GAUSSIAN-DATASET Raw Data Directory

This directory should contain the raw diabetic-retinopathy-gaussian-dataset dataset files downloaded from Kaggle.

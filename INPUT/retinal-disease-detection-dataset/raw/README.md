# RETINAL-DISEASE-DETECTION-DATASET Raw Data Directory

This directory should contain the raw retinal-disease-detection-dataset dataset files downloaded from Kaggle.
